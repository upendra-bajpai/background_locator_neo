...
NSString *const kChannelId = @"upendra.bajpai.background_locator_neo/locator_plugin";
NSString *const kBackgroundChannelId = @"upendra.bajpai.background_locator_neo/locator_plugin_background";
